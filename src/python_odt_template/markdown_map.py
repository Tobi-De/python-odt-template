...
transform_map = {
    "a": {
        "replace_with": "text:a",
        "attributes": {"xlink:type": "simple", "xlink:href": ""},
    },
    "p": common_styles["p"],
    ...
    "h1": {
        "replace_with": "text:p",
        "style_attributes": {"style-name": "Heading_20_1"},
    },
    "h2": {
        "replace_with": "text:p",
        "style_attributes": {"style-name": "Heading_20_2"},
    },
    "h3": {
        "replace_with": "text:p",
        "style_attributes": {"style-name": "Heading_20_3"},
    },
    "h4": {
        "replace_with": "text:p",
        "style_attributes": {"style-name": "Heading_20_4"},
    },
    "pre": {
        "replace_with": "text:p",
        "style_attributes": {"style-name": "Preformatted_20_Text"},
    },
    "code": {
        "replace_with": "text:span",
        "style_attributes": {"style-name": "Preformatted_20_Text"},
